                    ...
                    <div class="space-y-6">
                        <div class="dialog-detail-header">
                            <div>
                                ...
                                <p class="text-sm text-muted-foreground">
                                    {{ item.jobTitle || '—' }} ·
                                    {{ item.companyRef?.name || item.company || 'No company' }}
                                </p>
                            </div>
                            <app-badge [variant]="statusBadgeVariant(item.status)">{{
...
export class ContactDetailDialogComponent implements OnInit {
    ...
    private readonly dialogRef = inject(
        DialogRef<ContactDetailDialogComponent, ContactDetailDialogResult>,
    );
