                ...
                @if (mode() === 'edit') {
                    ...
                    <div class="space-y-6">
                        <div class="dialog-profile-header">
                            ...
                            <app-badge [variant]="accountStatusVariant(user)">{{
                                ...
                                <div class="space-y-1">
                                    ...
                                    <dd>
                                        @if (field.type === 'badge' && field.badgeVariant) {
                                            <app-badge [variant]="field.badgeVariant">{{
                                                field.value
                                            }}</app-badge>
                                        } @else {
                            ...
                            <div class="flex items-center justify-between gap-2">
                                <div class="space-y-0.5">
                                    ...
                                    <p class="text-xs text-muted-foreground">
                                        Manage permissions for this account
                                    </p>
                                </div>
                                <app-dropdown-menu align="end">
                                    <button
                                        ...
                                        [disabled]="
                                            isRoleUpdating() || assignableRoles().length === 0
                                        "
                                    >
                                        Assign role
                                        <app-icon
                                    ...
                                    <div dropdownContent>
                                        @for (role of assignableRoles(); track role.id) {
                                            ...
                                            <app-dropdown-item [disabled]="true"
                                                >All roles assigned</app-dropdown-item
                                            >
                                        }
                                    </div>
                                </app-dropdown-menu>
...
export class UserDetailDialogComponent implements OnInit {
    ...
    private readonly dialogRef = inject(
        DialogRef<UserDetailDialogComponent, UserDetailDialogResult>,
    );
