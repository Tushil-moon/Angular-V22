            ...
            <app-card>
              ...
              <app-card-body contentClass="space-y-6">
                ...
                <div class="settings-section">
                  ...
                  @if (lastInviteToken()) {
                    <p class="text-xs text-muted-foreground break-all rounded-md border border-border p-3 settings-invite-token">
          ...
          <div class="settings-panel">
            <app-card>
              <app-card-header [row]="true">
                ...
                <app-button variant="outline" size="sm" type="button" (clicked)="sessionService.reload()">
                  Refresh
                </app-button>
              </app-card-header>
                ...
                @if (sessionService.isLoading()) {
                  ...
                  <div class="empty-state py-16">
                    <div class="flex-table-empty-icon" aria-hidden="true">
                      <app-icon name="shield" [size]="20" className="text-muted-foreground" />
                    </div>
                    <p class="empty-state-title">No active sessions</p>
                    <p class="empty-state-description">Signed-in devices will appear here.</p>
                  </div>
                } @else {
