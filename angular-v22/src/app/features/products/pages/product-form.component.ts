/**
 * Add / Edit Product — production catalog form
 */
...
import { CategoryTreePickerComponent } from '../components/category-tree-picker.component';
import {
    type ProductImageDraft,
    ProductImagesPanelComponent,
} from '../components/product-images-panel.component';
    ...
    template: `
        <div class="index-page">
            <div class="index-header">
                <div class="index-header-copy">
                    ...
                    <p class="index-subtitle">
                        {{
                            isEdit()
                                ? 'Update catalog details, pricing, and merchandising'
                                : 'Create a storefront-ready catalog product'
                        }}
                    </p>
                </div>
                <div class="index-actions">
                    @if (isEdit() && loadedProduct()) {
                        <app-badge [variant]="statusVariant(loadedProduct()!.status)">
            ...
            @if (isEdit() && isLoadingProduct()) {
                ...
                <div class="home-grid !xl:grid-cols-[minmax(0,1.5fr)_minmax(18rem,0.85fr)]">
                    <div class="space-y-4">
                    ...
                    <aside class="space-y-4">
                        <section class="home-panel">
                            <div class="home-panel-header">
                                <div>
                                    <h2 class="home-panel-title">Organization</h2>
